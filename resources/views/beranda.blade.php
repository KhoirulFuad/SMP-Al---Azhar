...
<div class="max-w-6xl mx-auto flex items-center justify-between px-4">
  ...
  <nav class="flex-1 flex justify-center">
    <ul class="flex gap-16 text-white text-base font-semibold">
...
<footer class="bg-gray-900 text-white">
  ...
  <div class="max-w-6xl mx-auto px-4 py-12 grid md:grid-cols-3 gap-10">
    ...
    <div>
      ...
      <div class="flex items-start gap-3 mb-3">
        ...
        <p class="text-gray-300 text-sm">Jl. Ahmad Yani No.1, Pontianak, Kalimantan Barat</p>
      </div>
    ...
    <div>
      ...
      <div class="flex gap-3 mb-6">
        ...
        <a href="#" class="bg-green-700 hover:bg-green-600 transition p-2.5 rounded-full">
      ...
      <ul class="space-y-2 text-sm text-gray-400">
        ...
        <li><a href="#" class="hover:text-white transition-colors">Profil Kami</a></li>
        ...
        <li><a href="#" class="hover:text-white transition-colors">PMB</a></li>
      </ul>
    ...
    <div>
      ...
      <div class="rounded-xl overflow-hidden border-2 border-green-700">
        <iframe 
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.5678!2d109.3300!3d-0.0263!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e1d58a4b1234567%3A0xabcdef1234567890!2sSMP%20Islam%20Al-Azhar%2017%20Pontianak!5e0!3m2!1sid!2sid!4v1234567890"
          width="100%" 
          height="220" 
          style="border:0;" 
          allowfullscreen="" 
  ...
  <div class="py-4 text-center text-sm text-gray-500">
    &copy; 2026 SMP Islam Al-Azhar 17 Pontianak. All rights reserved.
  </div>
